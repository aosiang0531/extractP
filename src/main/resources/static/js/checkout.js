$(function() {
	...
	function init() {
		...
		var member_url = "orderInfo/" + memberId + "/unplaced";
		var orderId;
		...
		function info() {
			...
			fetch(pay_url)
				...
				.then(payment => {
		            ...
		            <p class="d-flex" name="beforetotal">
		              <span style="color:black;">商品總金額</span>
		              <span style="color:#c49b63;">$${payment.total}</span>
		            </p>
		            <p class="d-flex" name="shippingfee">
		              <span style="color:black;">運費</span>
		              <span style="color:#c49b63;">$60</span>
		            </p>
		            <hr>
			...
			district_box.addEventListener('change', () => {
				...
				const zipcode_value = database[selected_country][selected_district]
